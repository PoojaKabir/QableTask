...
//	ProductPage productpage;
	...
	@And("increase and decrease quantity")
	public void increase_decrease() {
		productpage.increaseAndDecreaseQuantity();
	}
	
	@And("remove product and verify")
	public void remove_product_and_verify() {
		productpage.removeAndVerify();
	}
